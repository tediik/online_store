...
public class AllUsersRestController {
    ...
    @ApiOperation(value = "Fetches email and roles of logged in user", response = ResponseEntity.class)
    ...
    @ApiOperation(value = "uploads images", response = ResponseEntity.class)
    ...
    @ApiOperation(value = "deletes images", response = ResponseEntity.class)
     ...
     */
    @PutMapping("/restore")
    @ApiOperation(value = "restores deleted users profile", response = ResponseEntity.class)
    @ApiResponses(value = {
