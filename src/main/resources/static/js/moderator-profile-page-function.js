...
/**
 * Method for moderator's pass changing
 * @returns {boolean}
 */
function changePass() {
    var formData = $('#formChangePass').serialize();
    $.ajax({
        url: '/api/moderator/change-password',
        type: 'POST',
        data: formData,
...
/**
 * Method for changing moderator's mail
 * @returns {boolean}
 */
function changeMail() {
...
/**
 * Method for checking that new moderator's pass is match requirements
 */
