...
public class ProductRestController {
   ...
   */
  @PostMapping("/rating")
  public ResponseEntity getNewRating(
   ...
   * @return - {@link ResponseEntity} response entity with List of {@link Product} or if there are
   *     no such products returns notFound
   */
