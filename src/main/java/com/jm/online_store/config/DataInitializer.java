    ...
    private void newsInit() {
        ...
        News eighthNews = News.builder()
                ...
                .fullText("<p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px;" +
                        ...
                        "обратить внимание при покупке телевизора. " +
        ...
        News ninthNews = News.builder()
                ...
                .fullText("<p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px;" +
                        ...
                        "программы приготовления отдельных блюд — рыбы, птицы и даже выпечки.\n" +
                        "Мощность\n" +
                        ...
                        "поискать пароварку мощнее: 1500-2000 Вт, а то и более 2000 Вт.\n" +
                        "Объем\n" +
                        ...
                        "чаши предусмотрен свой поддон, этого не произойдет.\n" +
                        "Материал чаши\n" +
                        "Пластиковые лотки\n" +
                        ...
                        "продукты с вечера, получили блюдо утром.\n" +
                        ...
                        "кредит или с использованием бонусных карт." +
                        "В online_store представлен огромный выбор телевизоров. Также у нас вы найдете все " +
                        "необходимые аксессуары, чтобы в полной мере наслаждаться просмотром телепередач.</b><br></p>" +
                        "<p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px;" +
                        " color: rgb(0, 0, 0); font-family: &quot;PT Sans&quot;, Arial, sans-serif;\">" +
        ...
        News tenthNews = News.builder()
                ...
                .fullText("<p style=\"margin-right: 0px; margin-bottom: 1em; margin-left: 0px; padding: 0px;" +
                        " font-family: &quot;PT Sans&quot;, Arial, sans-serif;\"><b style=\"color: rgb(255, 0, 0);" +
                        " font-size: 1rem;\">Свобода передвижения, неизведанные дали, неограниченный объем багажа — многие обожают путешествовать машиной! Однако легкомысленные сборы могут привести к сложностям в дороге. Поэтому первый шаг к идеальной автомобильной поездке — составить чек-лист необходимых вещей.\n" +
                        "\n" +
                        "Какие гаджеты взять с собой и как подготовиться к поездке — подскажет online_store." +
                        "Путеводитель\n" +
