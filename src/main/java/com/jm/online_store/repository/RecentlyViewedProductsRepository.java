...
public interface RecentlyViewedProductsRepository extends JpaRepository<RecentlyViewedProducts, Long> {
    ...
    List<RecentlyViewedProducts> findRecentlyViewedProductsByUserIdAndAndDateTimeBetween(Long id, @NonNull LocalDateTime dateTime, @NonNull LocalDateTime dateTime2);
}
